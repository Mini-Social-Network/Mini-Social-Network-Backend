...
{{- define "rabbitmq.envVars" -}}
- name: RABBITMQ_HOST
  value: "rabbitmq.mini-social-network-backend.svc.cluster.local"
- name: RABBITMQ_PORT
  value: "5672"
{{- end -}}
